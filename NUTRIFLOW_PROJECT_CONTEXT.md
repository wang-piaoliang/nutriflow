...
- 主食经用户补充确认：用的是「盒马有机七色糙米」（配料：有机燕麦米/黑米/糙米/高粱米/荞麦米/大麦米/红米），用户又自己加了大米、藜麦、小米。写作 `{name:"七色糙米饭（＋大米·藜麦·小米）", as:"杂粮饭"}`——页面显示具体品名、统计按 `杂粮饭` 归主食。只改了 07-24 这一天；07-20/21/23 的主食仍写作 `藜麦米饭`，若用户确认那几天也是同款再统一。
