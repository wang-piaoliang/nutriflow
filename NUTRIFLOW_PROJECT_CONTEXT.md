...
- 现有记录：2026-07-26（午餐、晚餐）、2026-07-25（午餐、晚餐）、2026-07-24（午餐、晚餐寿司郎）、2026-07-23（午餐、晚餐）、2026-07-22（午餐、晚餐）、2026-07-21（午餐、晚餐）、2026-07-20（午餐、晚餐）。07-24 起由用户 thread 直传照片录入，更早来自同步包。源数组按日期倒序书写，页面也按日期倒序渲染。
